...
- **Rich Text Nodes**:
  - Formatting toolbar: bold, italic (inline when shape/connection selected)
  - Color controls for text, background, and borders
  - Line style editing for connections (solid, dashed, dotted)
  - Supports formatted content with visual preview
