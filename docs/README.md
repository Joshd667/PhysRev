...
2. **[TEAMS_AUTH_ARCHITECTURE.md](TEAMS_AUTH_ARCHITECTURE.md)** - Evaluate Teams authentication options
3. **[TEAMS_AUTH_IMPLEMENTATION.md](TEAMS_AUTH_IMPLEMENTATION.md)** - Configure Microsoft Teams authentication
...
| Guide | Description | When to Use |
|-------|-------------|-------------|
| **[TEAMS_AUTH_ARCHITECTURE.md](TEAMS_AUTH_ARCHITECTURE.md)** | Technical decision guide for Microsoft Teams authentication with Azure database options comparison | Understanding architecture options, choosing authentication methods, evaluating database choices (SQL/Cosmos/OneDrive), analyzing costs and security |
| **[TEAMS_AUTH_IMPLEMENTATION.md](TEAMS_AUTH_IMPLEMENTATION.md)** | Step-by-step Microsoft Teams authentication setup and Azure AD configuration | Implementing Teams authentication, configuring OAuth, troubleshooting login issues, testing procedures |
...
### Authentication
- **Teams Authentication Architecture:** [TEAMS_AUTH_ARCHITECTURE.md](TEAMS_AUTH_ARCHITECTURE.md) (Decision guide with database options and cost analysis)
- **Teams Authentication Implementation:** [TEAMS_AUTH_IMPLEMENTATION.md](TEAMS_AUTH_IMPLEMENTATION.md) (Step-by-step setup guide)
- **Azure AD Configuration:** [TEAMS_AUTH_IMPLEMENTATION.md](TEAMS_AUTH_IMPLEMENTATION.md#step-1-azure-ad-app-registration)
- **Disabling Teams Login:** [TEAMS_AUTH_IMPLEMENTATION.md](TEAMS_AUTH_IMPLEMENTATION.md#option-1-disable-teams-login)
...
1. **[TEAMS_AUTH_ARCHITECTURE.md](TEAMS_AUTH_ARCHITECTURE.md)** - Evaluate options and make decisions
2. **[TEAMS_AUTH_IMPLEMENTATION.md](TEAMS_AUTH_IMPLEMENTATION.md)** - Follow step-by-step setup (Currently disabled, guide explains setup process)
...
**Total Guides:** 12 (including PERFORMANCE.md, renamed Teams auth guides, removed COLLEGE_SETUP.md)
